...
function EntryAluno() {
    ...
    var infoUsers = { matricula: '2345678', nome: 'Vinícius', periodo: '10' }
    var familias = [
                ...
                <div className="popUpCancelOperation">
                    <div className="popUpCancelCard">
                        ...
                        <div className='popUpCancelButtons'>
                            <button className='button-3' onClick={() => setShowPop(false)} >
                                Voltar
                            </button>
                            <button className='button-2' onClick={navigateToHomeAluno} >
                                Continuar
                            </button>
                        </div>
                    </div>
